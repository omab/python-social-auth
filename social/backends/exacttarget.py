...
class ExactTargetOAuth2(BaseOAuth2):
    ...
    def get_user_id(self, details, response):
        ...
        as only the token is available in response. details is much richer:
        {
        'expiresIn': 1200,
        ...
        'id': 123456, 
        'culture': 'en-US',
        'timezone': {'shortName': 'CST', 'offset': -6.0, 'dst': False, 'longName': '(GMT-06:00) Central Time (No Daylight Saving)'}, 
